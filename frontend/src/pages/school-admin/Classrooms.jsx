    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">{classrooms.length} classe(s)</p>
        </div>
      ...
      {loading ? <p className="text-gray-400">Chargement...</p> : (
        <div className="grid grid-cols-3 gap-4">
          {classrooms.length === 0 ? (
            <p className="text-gray-400 col-span-3 text-center py-10">Aucune classe trouvée</p>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-[460px] shadow-2xl">
            <h2 className="text-base font-semibold text-gray-800 mb-5">
              {editClassroom ? 'Modifier la classe' : 'Ajouter une classe'}
            </h2>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1.5">Niveau</label>
                <select
                  value={form.niveau}
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1.5">Enseignant responsable</label>
                <select
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button type="submit"
                  ...
                  {editClassroom ? 'Modifier' : 'Ajouter'}
                </button>
              </div>
            </form>
          </div>
